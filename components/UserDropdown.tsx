...
const UserDropdown = () => {
    ...
    const user={name: 'Shreya', email: 'shreya.amalapurapu@gmail.com'};
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-centergap-3 text-gray-4 hover:text-yellow-500">
                    <Avatar className='h-8 w-8'>
                        <AvatarImage src="https://avatars.githubusercontent.com/u/153423955?s=2805v=4" />
            ...
            <DropdownMenuContent className="text-grapy-400">
                <DropdownMenuLabel>
